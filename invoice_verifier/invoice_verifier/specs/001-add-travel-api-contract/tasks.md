...
| ID  | Task | File | Status |
|-----|------|------|--------|
| 4.1 | Bandingkan `travel_api_contract.json` vs FastAPI runtime schema | `web/travel_api_contract.json` | [X] |
| 4.2 | Verifikasi `"openapi": "3.1.0"` di contract | `web/travel_api_contract.json:2` | [X] |
| 4.3 | Verifikasi semua field model tercermin di contract | `web/travel_api_contract.json` | [X] |
| 4.4 | Verifikasi `APIKeyHeader` security scheme | `web/travel_api_contract.json:449-455` | [X] |
